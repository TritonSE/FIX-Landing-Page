...
<script lang="ts">
  ...
  import cat1 from './img/modal/cat1.png?format=avif';
  import cat2 from './img/modal/cat2.png?format=avif';
  import cat3 from './img/modal/cat3.png?format=avif';
  import cat4 from './img/modal/cat4.png?format=avif';
  import cat5 from './img/modal/cat5.png?format=avif';
  import cat6 from './img/modal/cat6.png?format=avif';
  import cat7 from './img/modal/cat7.png?format=avif';
  import cat8 from './img/modal/cat8.png?format=avif';
