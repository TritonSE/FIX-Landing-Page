...
<script>
  ...
  import about_header from './img/about_header.png?format=avif';
  import top_image from './img/top_image.png?format=avif';
  import bottom_image from './img/bottom_image.png?format=avif';
  import mobile_about from './img/mobile-about.png?format=avif';
