...
{#if showQuiz && !quizComplete}
  ...
  <div class="modalPopUp" on:click={handleClickOutside}>
    <div class="anotherOne">
      <div class="tabs">
        <button class={currentTab === 0 ? 'active quiz' : 'quiz'} on:click={() => switchTab(0)}
          >Quiz</button
        >
        <button class={currentTab === 1 ? 'active' : ''} on:click={() => switchTab(1)}
          >Review Roadmap</button
        >
      </div>
      <div class="modal">
...
{#if showQuiz && quizComplete}
  ...
  <div class="modalPopUp" on:click={handleClickOutside}>
    <div class="anotherOne">
      ...
      <div
        class="modal result"
        style={currentTab == 0 ? 'background-color: white;' : 'background-color: #83CDC0;'}
      >
        <div id="progressBar" style="width: {(quizInd + 1) * 16.667}%" />
        <!-- svelte-ignore a11y-click-events-have-key-events -->
        <div
          ...
          <div class="content">
            <div class="result-content">
              ...
              <Button
                ...
                style="width:8vw; height: 3vw; margin-top: 0.5vw; background: #58C3AF; border-radius: 4px; font-size: 0.7vw"
                ><div id="play-again">Play again!</div></Button
              >
            </div>
          </div>
        {/if}
      ...
      <div class="content">
        <div class="result-content">
          ...
          <Button
            ...
            style="width:30vw; height:15vw; margin-top: 0.5vw; background: #58C3AF; border-radius: 4px; font-size: 0.7vw"
            ><div id="play-again">Play again!</div></Button
          >
        </div>
      </div>
